...
plt_ax12.varimax = plt_nonphyloPCA_biplot_ax12.varimax + plt_nonphyloPCA_contribplot_ax12.varimax + 
  #plot_annotation(title = "PC1-2, biplot and contribution plot") +
  plot_layout(guides = "collect") & theme(legend.position='right')

plt_ax23.varimax = plt_nonphyloPCA_biplot_ax23.varimax + plt_nonphyloPCA_contribplot_ax23.varimax + 
  #plot_annotation(title = "PC2-3, biplot and contribution plot") +
  plot_layout(guides = "collect") & theme(legend.position='right')
...
# ggsave(plot = plt_ax12_ax23_combined, filename = "2502-indv-level-code/Ind_nonphyPCA_ax123_RLES.pdf",
#        width = 6.5, height = 7)

plt_ax12_ax23_combined.varimax = plot_grid(plt_ax12.varimax, plt_ax23.varimax, ncol = 1)
ggsave(plot = plt_ax12_ax23_combined.varimax, filename = "2502-indv-level-code/Ind_nonphyPCA_ax123_RLESRDMCLPC_varimax.pdf",
       width = 6.5, height = 7)
