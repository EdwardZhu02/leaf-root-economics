...
# variables = c("RTD","SRL","RD","RNC","RCC","RPC","SRR25","RDMC","LMA","LNC","LCC","LPC","Rdark25P", "Rlight25P","rs25","Vcmax25","Asat","vH","WD","Ks","TLP","SWCleaf","SWCbranch","H","DBH")
variables = c("LCC","LMA","LNC","LPC","Rdark25P","Vcmax25","Asat","RCC","RD","RDMC","RNC","RPC","RTD","SRA","SRL","SRR25")
...
plt_htmap_lambda = ggplot(data = melted_lambda_matrix, aes(Var2, Var1, fill = value)) +
  ...
  scale_fill_gradient2(low = "white", high = "#A0BDD5",
                       na.value = "grey50",
...
ggsave(plot=plt_htmap_lambda, filename="plt_PGLS_htmap_lambda_all.pdf", width=5, height=4.3)
...
ggsave(plot=plt_htmap_pvalue, filename="plt_PGLS_htmap_pranova_all.pdf", width=6, height=3)
...
ggsave(plot=plt_htmap_rsq, filename="plt_PGLS_htmap_rsq_all.pdf", width=6, height=3)
