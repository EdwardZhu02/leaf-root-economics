...
PCAresult_RESLES_RDMC = func_nonphyPCA_stepwise(
  c("RTD","SRL","RD","RNC","LMA","LNC","RDMC"), nonphyloPCAData_numonly)
# RES + LES + LPC
...
PCAresult_RESLES_RDMCLPC = func_nonphyPCA_stepwise(
  c("RTD","SRL","RD","RNC","LMA","LNC","RDMC","LPC"), nonphyloPCAData_numonly)
...
plt_anglecorr_addRDMC = ggplot(data=varAngleMelted_combined,
  ...
  geom_point(aes(color=pair_annotation), size=2.7, alpha=0.9) +
